...
<aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div>
        ...
        <div className="mt-8 text-center">
            <img src="https://scontent.fhan14-1.fna.fbcdn.net/v/t39.30808-6/348975680_915434769749652_6407145337707290420_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=4rben9AkugcAX-iNOPJ&_nc_ht=scontent.fhan14-1.fna&oh=00_AfAhgj9HMhfvDbPgxpS_lD2Quzs7xnZyAwUYYiM6d1WANw&oe=64B9112D" alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28"/>
            <h5 className="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Trần Lương</h5>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <a href='/admin/categories' className="group-hover:text-gray-700">Categories</a>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <a href='/admin/products'  className="group-hover:text-gray-700">Product</a>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
    ...
    <div className="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
        <button className="px-4 pb-10 flex items-center space-x-4 rounded-md text-gray-600 group">
