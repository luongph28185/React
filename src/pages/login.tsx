...
<section className="bg-black opacity-90 absolute mt-32 ml-[500px]">
  <div className=" lg:w-4/12 px-4  pt-6">
    <div className="relative flex flex-col min-w-0 break-words  mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
      <p className='text-white font-bold ml-10 my-5 text-[25px]'>Đăng nhập</p>
      <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
        ...
        <form className='w-[500px]'>
          ...
          <div className="text-center mt-6">
            <button className="bg-red-900 text-white hover:bg-red-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150" type="button"> Sign In </button>
          </div>
          ...
          <div className='mt-24'>
    <p className=' text-[20px] my-3 text-gray-300'>Đăng ký ngay trở thành KHTT của Hades ? <a href='/register' className='text-blue-500'>đăng ký ngay</a></p>
